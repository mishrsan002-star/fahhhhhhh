...
window.RuntimeInterface = class a {
  ...
  async _InitDOM(b, c) {
    ...
    for (let [g, h] of f)
      if (h || (h = g), g === e) try {
        h = await this._MaybeGetCordovaScriptURL(h), await AddScript(h), "preview" !== this._exportType || d[g] ||
          this._ReportProjectMainScriptError(g, "main script did not run to completion")
      } catch (k) {
  ...
  _SendWrapperMessage(b) {
    ...
    else if ("macos-wkwebview" ===
      this._exportType) window.webkit.messageHandlers.C3Wrapper.postMessage(JSON.stringify(b));
...
window.C3_IsSupported && (window.c3_runtimeInterface = new self.RuntimeInterface({
  useWorker: !0,
  workerMainUrl: "https://cdn.jsdelivr.net/gh/bubbls/UGS-Assets@main/throw-a-patata-space/workermain.js",
  engineScripts: ["https://cdn.jsdelivr.net/gh/bubbls/UGS-Assets@main/throw-a-patata-space/scripts/c3runtime.js"],
  projectScripts: [],
  mainProjectScript: "",
...
self.AudioDOMHandler = class extends self.DOMHandler {
  ...
  GetDestinationForTag(a) {
    return (a = this._effects.get(a.toLowerCase())) ?
      a[0].GetInputNode() : this.GetDestinationNode()
  }
  AddEffectForTag(a, b) {
    a = a.toLowerCase();
  ...
  async _GetAudioBuffer(a, b, c, d, e) {
    for (const f of this._audioBuffers)
      if (f.GetUrl() === b) return await f.Load(),
        f;
    if (e) return null;
  ...
  async _GetAudioInstance(a, b, c, d, e) {
    ...
    a = (await this._GetAudioBuffer(a,
      b, c, e)).CreateInstance(d);
  ...
  _MaybeStartTicking() {
    if (0 <
      this._analysers.size) this._StartTicking();
    else
  ...
  _SetStereoPan(a) {
    const b =
      a.tag;
    a = a.p;
    for (const c of this.audioInstancesByTag(b)) c.SetStereoPannerEnabled(!0), c.SetStereoPan(a)
  }
  async _FadeVolume(a) {
    const b = a.tag,
      c = a.vol,
  ...
  _OnTick(a) {
    ...
    !(b = a.listenerPos) || this._lastListenerPos[0] === b[0] && this._lastListenerPos[1] === b[1] && this._lastListenerPos[2] === b[2] || (this._lastListenerPos[0] = b[0], this._lastListenerPos[1] = b[1], this._lastListenerPos[2] = b[2], this._audioContext.listener.setPosition(b[0], b[1],
      b[2]));
    if ((b = a.listenerOrientation) && (this._lastListenerOrientation[0] !== b[0] || this._lastListenerOrientation[1] !== b[1] || this._lastListenerOrientation[2] !== b[2] || this._lastListenerOrientation[3] !== b[3] || this._lastListenerOrientation[4] !== b[4] || this._lastListenerOrientation[5] !== b[5])) {
    ...
    for (const c of a.instPans) {
      ...
      for (const d of this._audioInstances) d.GetUID() ===
        a && d.SetPanXYZA(c.x, c.y, c.z, c.angle)
    }
  }
  async _AddEffect(a) {
    var b = a.type;
    ...
    if ("filter" === b) d = new self.C3AudioFilterFX(this, ...d);
      ...
      d._SetBufferInfo(a.bufferOriginalUrl,
        a.bufferUrl, a.bufferType)
    ...
    else if ("compressor" === b) d = new self.C3AudioCompressorFX(this,
      ...d);
  ...
  async _OnLoadState(a) {
    ...
    if (3 !== b) {
      var c = [];
      for (var d of this._audioInstances) d.IsMusic() && 1 === b || !d.IsMusic() &&
        2 === b ? c.push(d) : d.Release();
  ...
  _OnGetOutputStream() {
    this._destMediaStreamNode ||
      (this._destMediaStreamNode = this._audioContext.createMediaStreamDestination(), this._destinationNode.connect(this._destMediaStreamNode));
...
self.C3AudioInstance = class {
  ...
  SetPannerEnabled(a) {
    a = !!a;
    this._isPannerEnabled !== a && ((this._isPannerEnabled = a) ? (this.SetStereoPannerEnabled(!1), this._pannerNode || (this._pannerNode = this.GetAudioContext().createPanner(), this._pannerNode.panningModel = this._audioDomHandler.GetPanningModel(), this._pannerNode.distanceModel = this._audioDomHandler.GetDistanceModel(), this._pannerNode.refDistance =
  ...
  SetPan(a, b, c, d, e, f, g) {
    this._isPannerEnabled && (this.SetPanXYZA(a, b, c, d), a = self.AudioDOMHandler.ToDegrees,
      this._pannerConeParams[0] !== a(e) && (this._pannerConeParams[0] = a(e), this._pannerNode.coneInnerAngle = a(e)), this._pannerConeParams[1] !== a(f) && (this._pannerConeParams[1] = a(f), this._pannerNode.coneOuterAngle = a(f)), this._pannerConeParams[2] !== g && (this._pannerConeParams[2] = g, this._pannerNode.coneOuterGain = g))
  }
  SetPanXYZA(a, b, c, d) {
  ...
  LoadStereoPanState(a) {
    "number" !== typeof a ? this.SetStereoPannerEnabled(!1) : (this.SetStereoPannerEnabled(!0), this.SetStereoPan(a))
  }
};
"use strict";
